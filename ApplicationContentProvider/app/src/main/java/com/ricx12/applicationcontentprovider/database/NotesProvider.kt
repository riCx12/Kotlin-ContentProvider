package com.ricx12.applicationcontentprovider.database
...
import com.ricx12.applicationcontentprovider.database.NoteDatabaseHelper.Companion.TABLE_NOTES
...
class NotesProvider : ContentProvider() {
    ...
    override fun delete(uri: Uri, selection: String?, selectionArgs: Array<String>?): Int {
        if(mUriMatcher.match(uri) == NOTES_BY_ID) {
         ...
         val linesAffectingSpan = db.delete(TABLE_NOTES, "$_ID", arrayOf(uri.lastPathSegment))
         db.close()
    ...
    companion object{
        const val AUTHORITY = "com.ricx12.applicationcontentprovider.provider"
