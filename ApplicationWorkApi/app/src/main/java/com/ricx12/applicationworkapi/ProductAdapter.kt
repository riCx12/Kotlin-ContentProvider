...
class ProductAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ProductViewHolder = ProductViewHolder(LayoutInflater.from(parent).inflate(R.layout.product_item, parent, false))
